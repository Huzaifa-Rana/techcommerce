...
<main class="content-wrapper">
            ...
            <div class="col-md-5 order-md-1">
                <div class="position-relative py-5 px-4 px-sm-5">
                    ...
                    <div class="position-relative z-1 py-md-2 py-lg-4 py-xl-5 px-xl-2 px-xxl-4 my-xxl-3">
                        <h1 class="pb-1 pb-md-2 pb-lg-3">Tech Commerce - More than a retailer</h1>
    ...
    <section class="container pt-3 pt-sm-4 pt-lg-5 mt-lg-2 mt-xl-4 mt-xxl-5" id="mission" style="scroll-margin-top: 60px">
        <div class="text-center mx-auto" style="max-width: 690px">
            ...
            <h6 class="mb-0">William Lacker, Tech Commerce CEO</h6>
        </div>
    </section>
                            ...
                            <div class="swiper-slide w-auto h-auto">
                                <div class="card h-100 rounded-4 px-3" style="max-width: 306px">
                                    <div class="card-body py-5 px-3">
                                        ...
                                        <p class="mb-0">Tech Commerce people are young, ambitious and energetic individuals. With identified leadership qualities, with a desire to be the best at what they do.</p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <ul class="list-unstyled d-flex flex-column gap-4 ps-md-4 ps-lg-0 mb-3">
                        <li class="nav flex-nowrap align-items-center position-relative">
                            ...
                            <div class="ps-3">
                                ...
                                <a class="nav-link fs-sm hover-effect-underline stretched-link p-0" href="#!">5 New Cool Gadgets You Must See on Tech Commerce - Cheap Budget</a>
                            </div>
                        </li>
                        <li class="nav flex-nowrap align-items-center position-relative">
                            ...
                            <div class="ps-3">
                                ...
                                <a class="nav-link fs-sm hover-effect-underline stretched-link p-0" href="#!">5 Super Useful Gadgets on Tech Commerce You Must Have in 2023</a>
                            </div>
                        </li>
                        <li class="nav flex-nowrap align-items-center position-relative">
                            ...
                            <div class="ps-3">
                                ...
                                <a class="nav-link fs-sm hover-effect-underline stretched-link p-0" href="#!">Top 5 New Amazing Gadgets on Tech Commerce You Must See</a>
                            </div>
                        </li>
                    </ul>
